...
def plotar_clusters_pca(X, labels, variaveis, nome_saida="cluster_pca.png"):
    ...
    plt.grid(True)
    plt.tight_layout()
    plt.savefig(f"outputs/{nome_saida}")
    plt.close()

def plotar_pesos(variaveis, pesos, nome_saida="pesos_variaveis.png"):
