...
print("\n🔹 Clusters CLiNAP:", labels_clinap)
print("🔹 Pesos CLiNAP:", dict(zip(variaveis, pesos_clinap)))

# ✅ Aplicar CLiNAP-G
labels_g, pesos_g = aplicar_clinap_g(X, k=3)
print("\n🟢 Clusters CLiNAP-G:", labels_g)
...
# ✅ Salvar base com rótulos para dashboard
...
print("📁 Arquivo salvo: data/base_resultado.csv")
