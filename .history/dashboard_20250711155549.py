...
# Exportar Relatório Individual ou Geral em PDF
with st.expander("📄 Exportar relatório em PDF"):
    ...
    if escolha == "Relatório individual" and "paciente" in locals() and paciente is not None:
        html = f"""
        <html><body>
...
# Exportar Painel Estático com gráficos e tabela (descrição textual)
