...
plotar_clusters_pca(X, labels_clinap, variaveis)
plotar_pesos(variaveis, pesos_clinap)

plotar_clusters_pca(X, labels_g, variaveis)
plotar_pesos(variaveis, pesos_g)
