...
from src.preprocessamento import carregar_e_preprocessar_dados
X, variaveis = carregar_e_preprocessar_dados("data/base_simulada.csv")

# Aplicar o algoritmo CLiNAP
from src.clinap import clinap_com_pesos
labels, pesos = clinap_com_pesos(X)

# Exibir resultados
print("\n🔹 Clusters atribuídos:", labels)
print("\n📊 Pesos aprendidos por variável:", dict(zip(variaveis, pesos)))
