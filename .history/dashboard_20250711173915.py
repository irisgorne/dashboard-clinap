...
# Filtros de eixo (restritos a IMC, Calorias e HbA1c)
st.sidebar.markdown("---")
st.sidebar.subheader("📊 Seleção de Eixos")

opcoes_eixos = ["IMC", "Calorias", "HbA1c"]
x_axis = st.sidebar.selectbox("📈 Eixo X:", opcoes_eixos, index=opcoes_eixos.index("IMC"))
y_axis = st.sidebar.selectbox("📉 Eixo Y:", opcoes_eixos, index=opcoes_eixos.index("HbA1c"))
